...
{
    const STUBSPATH = __DIR__.'/light-bootstrap-stubs/';
    ...
    {
        static::copyDirectory('resources/assets', public_path('light-bootstrap'));
    }
    ...
    protected static function updateAuthViews()
    {
        ...
        // Copy light bootstrap auth views from the stubs folder
